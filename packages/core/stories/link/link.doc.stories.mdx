...
Link is an extension of [Text component](/docs/documentation-core-text--page) so it inherits all its properties. Link also extends the `HTMLAnchorElement` type so all anchor props are available to use.
